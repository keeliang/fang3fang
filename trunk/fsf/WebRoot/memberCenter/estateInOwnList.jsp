...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>管理发布 - 自主交易区求购求租信息 - 房上房地产网</title>
		...
		<div class="memberC_box">
			...
			<div class="guide">
				<p>
					...
					<span class="cOrange">管理发布 - 自主交易区求购求租信息</span>
				</p>
			</div>
						...
						<table id="tblList" border="0" cellpadding="0" cellspacing="0" width="100%" class="memberC_table">
							...
							<tbody>
								<s:iterator value="pageView.records" id="item">
									<s:url action="estateInOwnEdit" namespace="/memberCenter" id="url" includeParams="none">

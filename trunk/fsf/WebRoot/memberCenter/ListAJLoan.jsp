...
<script type="text/javascript" src="js/ListAJLoan.js"></script>
</head>
<body>
<div class="memberC_box">
   ...
   <%@ include file="../CommonPage/memberC_head.jsp" %> 
    ...
    <!-- guide -->
    <div class="guide">
        <p>您当前的所在位置：<a href="#">房上房</a> &gt;&gt; <a href="index.jsp">会员中心</a> &gt;&gt;  <span class="cOrange">管理发布 - 按揭贷款</span></p>
    </div>
    ...
    <div class="memberC">
        ...
        <div class="memberC_allRight02">
        	<!-- right -->
        	<p class="cGray02"><b>管理发布 - 按揭贷款</b> </p>
            <div class="blank10"></div>
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="memberC_table" id="ListAJLoanTable" name="ListAJLoanTable">
            	<thead>
            	<tr>
                	<td><b>编号</b></td>
                    <td><b>贷款人</b></td>

...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="js/Update_Ajloan.js"></script>
	</head>
	<body>
		<div class="memberC_box">
			...
			<div class="memberC">
				...
				<input name="referaction" type="hidden" id="referAction"
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								...
								<td>
									...
									<input type="radio" name="userSex" value="1" id="userSex"/>
									男&nbsp;&nbsp;
									<input type="radio"  name="userSex" value="0" id="userSex"/>
									女
								</td>								
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									...
									<input type="radio"  id="isMarried" name="isMarried" value="1"/>
									是&nbsp;&nbsp;
						...
						<input name="AJID" type="hidden" id="AJID" /> 
						<div class="blank10"></div>
						<div class="blank10"></div>
						<div class="blank10"></div>

...
<title>委托交易区 - 求购求租信息 - 房上房地产网</title>
		...
		<div class="memberC_box">
			...
			<div class="guide">
				<p>
					...
					<span class="cOrange">委托交易区 - 求购求租信息</span>
				</p>
			</div>
			...
			<div class="memberC">
				...
				<div class="memberC_allRight02">
					...
					<s:form namespace="/memberCenter" action="estateInOwnSave" name="formItem" id="formItem" theme="simple" onsubmit="return f_validate()" >
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%" id="saleTbl" style="display: none;">
							<tr>
								...
								<td>
									<s:textfield name="buyPriceFrom" ><s:param name="value" value="buyPriceFrom/10000" ></s:param></s:textfield>万元-
									<s:textfield name="buyPriceTo" ><s:param name="value" value="buyPriceTo/10000" ></s:param></s:textfield>万元
								</td>
							</tr>
						</table>

...
<s:hidden name="estateOutParameter._ne_estateId" />
...
<s:hidden name="estateOutParameter._se_develop" />
...
<s:hidden name="estateOutParameter._ne_area" />
<s:hidden name="estateOutParameter._ne_isLift" />
<s:hidden name="estateOutParameter._ne_practicalArea" />
<s:hidden name="estateOutParameter._ne_effective" />
<s:hidden name="estateOutParameter._se_estateAddress" />
<s:hidden name="estateOutParameter._ne_toward" />
<s:hidden name="estateOutParameter._ne_floor" />
<s:hidden name="estateOutParameter._ne_totalFloor" />
<s:hidden name="estateOutParameter._ne_salePrice" />
<s:hidden name="estateOutParameter._ne_rentPrice" />
...
<s:hidden name="estateOutParameter._ne_manageCost" />
<s:hidden name="estateOutParameter._ne_waterCost" />
<s:hidden name="estateOutParameter._ne_electricCost" />
<s:hidden name="estateOutParameter._ne_otherCost" />
<s:hidden name="estateOutParameter._ne_buildYear" />
<s:hidden name="estateOutParameter._ne_minMonth" />
<s:hidden name="estateOutParameter._ne_deposit" />
<s:hidden name="estateOutParameter._ne_fitment" />
<s:hidden name="estateOutParameter._ne_device" />
<s:hidden name="estateOutParameter._se_remark" />
<s:hidden name="estateOutParameter._se_imagePath" />
<s:hidden name="estateOutParameter._de_createTime" />
<s:hidden name="estateOutParameter._ne_createUserId" />
<s:hidden name="estateOutParameter._de_updateTime" />
<s:hidden name="estateOutParameter._ne_updateUserId" />
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <td class="content_td">
    	<s:select	list="@fsf.web.common.SelectTagStaticUtil@getConfig('$fitment')" cssClass="dropdown"
    ...
    <td class="content_td">
	    <s:select list="@fsf.web.common.SelectTagStaticUtil@getConfig('$device')" cssClass="dropdown"
...
function f_validate(){
	...
	var o = $('#tradeMode'); 
	if(o.val()==1 || o.val()==3){
		addfield("rentPrice","<s:text name="rentPrice"/>","Number",false,14);
		addfield("minMonth","<s:text name="minMonth"/>","Integer",false,10);
		addfield("waterCost","<s:text name="waterCost"/>","Number",false,6);
		addfield("electricCost","<s:text name="electricCost"/>","Number",false,6);
		addfield("otherCost","<s:text name="otherCost"/>","Number",false,12);
		addfield("deposit","<s:text name="deposit"/>","Number",false,12);
		...
		addfield("salePrice","<s:text name="salePrice"/>","Number",false,14);

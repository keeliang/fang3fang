...
<div class="infoList_box">
    ...
    <div class="infoList_content">
    	<s:iterator value="pageView.records" status="i">
				<p><span class="float_right cGray">${updateTime }</span>・<a target="_blank" href="<%=contextPath %>/Info/infoContent.action?informationId=${informationId }" class="font14">${informationTitle }</a></p>

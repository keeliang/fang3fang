		...
		<div class="infoShow_box">
			...
			<div class="infoShow_head">
				...
				<p>
					...
					<a href="<%=contextPath %>/forums/goToForum.action"><u>论坛</u></a> |
				...
				<div class="infoShow_contentL">
					...
					<div class="infoShow_contentL_guide">
						<p>
							...
							<a href="<%=contextPath %>/Info/infoIndexList.action">新闻</a> &gt;
							<a href="<%=contextPath %>/Info/newsList.action?newsParameter._ne_newsTypeId=${newsTypeId }&newsParameter.currentPage=1&newsParameter.maxResults=30">
								<fsf:dictTranslate groupName="#news_type" value="newsTypeId" />
							</a>
						</p>
					</div>

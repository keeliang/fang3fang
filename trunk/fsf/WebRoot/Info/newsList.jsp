	...
	<body>
		<div class="infoList_box">
			...
			<div class="infoList_guide">
				...
				<a href="<%=contextPath %>/Info/infoIndexList.action">新闻</a><span class="cOrange"></span>
			</div>

			<div class="infoList_title">
				<p>
					<span class="float_right">&nbsp;&nbsp; </span>
					<span class="font14"><b><fsf:dictTranslate groupName="#news_type" value="newsParameter._ne_newsTypeId" /></b>
					</span>
				</p>
			</div>
			...
			<div class="infoList_content">
				<s:iterator value="pageView.records" status="i">
					<p>
						...
						<a target="_blank"
							href="<%=contextPath%>/Info/newsContent.action?newsId=${newsId }"
							class="font14">${newsTitle }</a>
					</p>

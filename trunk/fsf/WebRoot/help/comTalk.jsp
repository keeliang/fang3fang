    ...
    <div class="help_content">
    	<div class="help_contentL">
            ...
            <div class="blank12"></div>
                ...
                <li class="help_menuNav01_02 on"><a href="comTalk.jsp"><span class="float_right">&gt;&gt;</span>联络洽谈</a></li>
        ...
        <div class="help_contentR">
        	<div class="help_contentR_title"><img src="images/comTalk.jpg" width="140" height="36" alt="联络洽谈" title="联络洽谈" /></div>
            <div class="help_contentR_line"></div>
            <p><b>1. 您联系到卖家后，需洽谈的重要事项包括如下：</b></p>
    		<div class="blank12"></div>
            <p class="help_dot">实地看房，建议自己联系业主看房时应提供身份证和联系地址、联系方法（真实电话） </p>           
            <div class="blank12"></div>
            <p class="help_dot">交易谈判，包括成交价格、交楼标准、时间、付款方式。这个环节是最重要的。通常谈判有个专业的第三方责任人，交易的成功率会高很多。交易就更有保障，建议您邀请房上房经纪人吧，还不行动？</p>           
            <div class="blank12"></div>
            <p class="help_dot">您如果没有交易经验，房上房自主交易网为您提供经纪人上门签约服务，您只要一个电话，我们就会有人专业上门为您提供服务。如需要请点击收费服务，或马上预约经纪人。</p>           
            <div class="blank12"></div>
            <div class="blank12"></div>
            <p><b>2. 房上房为买卖双方提供一个交易沟通平台。</b></p>
            <p class="indent30">在这里卖家发布房源，买家求购及查找房源，双方通过互联网的形式，发布寻找信息，网上联络洽谈。您如果是个网络通，那么下面这些网络联系方式就难不倒您了： </p>
            <div class="help_info02">
            	<p>自主交易社区   --  论坛互助,所有参与二手房买卖的个人均可在这里交流。 </p>
                <p>QQ群  --  希望能够找到同路人,交流信息更快更直接,就赶快加入我们的房上房的QQ群吧。 </p>
                <p>QQ号  --  您如果有QQ号，可以直接在这里与专业人士进行在线沟通。 </p>
                <p>Email  --  您有什么问题或者资料需要私下传递给银行及代办过户的专业人员,那么这个就非常保险了。</p>
                <p>银行在线按揭申请系统   --  在这里您把银行的需求提交后,可以查看得到银行对您的回复信息。</p>
                <p>房上房  --  专业咨服务电话：020-84881393 传真：020-84881510 </p>
            </div>
            <div class="blank12"></div>
            <p><b>3. <a href="chargeService.jsp" class="cOrange"><u>收费服务</u></a></b></p>
            <div class="blank12"></div>
            <p><b>4. <a href="freeService.jsp" class="cOrange"><u>免费服务</u></a></b></p>

    ...
    <div class="help_content">
    	<div class="help_contentL">
            ...
            <div class="blank12"></div>
                ...
                <li class="help_menuNav02_05 on"><a href="danbao.jsp"><span class="float_right">&gt;&gt;</span>担保赎楼</a></li>
        ...
        <div class="help_contentR">
        	<div class="help_contentR_title"><img src="images/help_danbao.jpg" width="140" height="36" alt="担保赎楼" title="担保赎楼" /></div>
            <div class="help_contentR_line"></div>
            <p class="cRed03 font12">如果您的房产处在按揭状态，请阅读以下内容，否则，请跳过本页。</p>
            <div class="blank12"></div>
            
            <p><b>1. 什么是赎楼 </b></p>
            <p class="indent24 font12">处在按揭状态中的房产，必须先结清原按揭贷款，解除原抵押登记手续后，才能办理产权过户手续。这种结清原贷款然后解除抵押的过程，称为赎楼。</p>
            <div class="blank12"></div>
            <p><b>2. 赎楼贷款与担保赎楼 </b></p>
            <p class="indent24 font12">卖房人可以选择以自有资金结清原按揭贷款。 也可以向银行申请赎楼贷款以结清原按揭贷款。银行向卖房人发放赎楼贷款，通常需要专业担保公司为该贷款提供保证担保，本过程称为担保赎楼。</p>
            <div class="blank12"></div>
            <p><b>3. 买家赎楼</b></p>
            <p class="indent24 font12">在实际操作中，也有买家替业主赎楼，也就是在签订合同时支付楼价3%的订金之后，业主您开始向银行申请提前还款，在银行还款当天，由买家支付首期款给业主。但前提是买家的首期款直接存入业主银行按揭的帐户，银行自动扣款等待拿证过户，那业主方要签收款收据！但这种情况下通常要有第三方的存在，如您邀请房上房，可以省去担保储资赎楼的费用，方便又有保障。</p>
            
            <div class="blank12"></div>
            <p><b>4. 赎楼担保流程</b></p>
            
            <div class="blank12"></div>
            <div class="help_contentR_title"><img src="images/help_danbao_liucheng.jpg" width="205" height="624" /></div>

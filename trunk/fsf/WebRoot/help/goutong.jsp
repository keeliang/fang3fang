    ...
    <div class="help_content">
    	<div class="help_contentL">
            ...
            <div class="blank12"></div>
                ...
                <li class="help_menuNav02_02 on"><a href="goutong.jsp"><span class="float_right">&gt;&gt;</span>沟通平台</a></li>
        ...
        <div class="help_contentR">
        	<div class="help_contentR_title"><img src="images/help_goutong.jpg" width="140" height="36" alt="沟通平台" title="沟通平台" /></div>
            <div class="help_contentR_line"></div>
            <div class="blank12"></div>
            <p class="indent24 font12">房上房为买卖双方提供一个交易沟通平台。在这里卖家发布房源，买家求购及查找房源，双方通过互联网的形式，发布寻找信息，网上联络洽谈。您如果是个网络通，那么下面这些网络联系方式就难不倒您了： </p>
          
            <div class="help_info03">
            	<div class="help_info04">
            	<p class="help_dot02">自主交易社区   --  论坛互助,所有参与二手房买卖的个人均可在这里交流。 </p>
                <p class="help_dot02">QQ群  --  希望能够找到同路人,交流信息更快更直接,就赶快加入我们的房上房的QQ群吧。</p>
                <p class="help_dot02">QQ号  --  您如果有QQ号，可以直接在这里与专业人士进行在线沟通。 </p>
                <p class="help_dot02">Email  --  您有什么问题或者资料需要私下传递给银行及代办过户的专业人员,那么这个就非常保险了。</p>
                <p class="help_dot02">银行在线按揭申请系统  --  在这里您把银行的需求提交后,可以查看得到银行对您的回复信息。</p>
                <p class="help_dot02">您可以直接跟业主进行电话沟通。</p>
                <p class="help_dot02">房上房  --  专业咨服务电话：020-84881393 传真：020-84881510</p>
                </div>
            </div>
            <div class="blank12"></div>
            <p><b>1. <a href="#" class="cOrange"><u>常见过户、抵押问题</u></a></b></p>
    		<div class="blank12"></div>

            <p><b>2. 房上房为您提供上门签约服务，全程仅需<span class="cOrange">1000</span>元，就有专业人员帮助您完成所有手续。</b></p>

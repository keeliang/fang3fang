...
<div class="box">
    ...
    <div class="help_content">
    	<div class="help_contentL">
            ...
            <div class="blank12"></div>
            <div class="help_menuNav01"><a href="chargeService.html"><b>收费服务</b></a></div>
            <div class="blank12"></div>
            <div class="blank12"></div>
        ...
        <div class="help_contentR">
        	<div class="help_contentR_title"><img src="images/help_chargeService.jpg" width="140" height="36" alt="收费服务" title="收费服务" /></div>
            <div class="help_contentR_line"></div>
            <p class="cRed03 font12">房上房为您提供房地产专业咨询，上门签署三方合同，办理房产证、水电、过户、交楼等全方位服务，全程服务费用仅需1000元。 </p>
            <div class="blank12"></div>
            
            <p><b>1. 全程服务内容包括： </b></p>
            <p class="help_dot">提供全程房地产专业咨询服务。</p>
            <p class="help_dot">电话邀请经纪人上门签署三方合同，并收取相关证件进行存管。</p>
            <p class="help_dot">告知您在签署合同前的各种准备。</p>
            <p class="help_dot">提供国土局网络版《广东省房地产买卖合同（现售）》文本打印服务。</p>
            <p class="help_dot">根椐政府部门相关规定协助买卖双方办理合同公证事宜（买卖一方为港澳台或外籍人士房产交易需公证）。 </p>
            <p class="help_dot">代理买卖双方到国土局办理房地产交易材料递件，领取并保管交易回执。  </p>
            <p class="help_dot">根椐房地产交易税收相关规定，协助买卖双方申请办理房地产交易有关税收的免税服务。</p>
            <p class="help_dot">协助买卖双方到国土部门缴纳税费，领取房地产证。</p>
            <p class="help_dot">代理买卖双方办理结清物业管理费及更名手续，并到相关部门办理水、电、煤气(天然气)、有限电视（数字电视）等过户手续。</p>
            <p class="help_dot">协助买按揭方、贷款所需的抵押登记服务。</p>
            <p class="help_dot">及时通知买卖双方办理交楼事宜。 </p>
            <div class="blank12"></div>
            <p><b>2. 买方通过自主交易网搜索到房源信息后需付费1元，查看到业主联系电话。 </b><span class="cRed font12">(会员免费)</span></p>
            
            <div class="blank12"></div>
            <p><b>3. 卖方可通过自主交易网查询到求购信息后需付费1元，查看买家联系电话，主动与买家联络。(会员免费) </b><span class="cRed font12">(会员免费)</span></p>

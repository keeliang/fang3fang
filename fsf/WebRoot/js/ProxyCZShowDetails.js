$(document).ready(function() {
	...
	$.ajax({
		...
		type: "POST",
		dataType: "xml",
		data: "referaction=SelectProxyCZByPCZID&PCZID=" + id,
		cache: false,

...
<div class="member_box">
    ...
    <%@ include file="../CommonPage/Member_head.jsp" %>
     ...
     <div class="member_regContent">
	       <div class="member_regContent_des"><h4>错误信息</h4></div> 
	 
		
		   <p>&nbsp;&nbsp;</p>
		   <div class="ErrorPageContent"><h5>对不起，您输入的验证码出错，请重新输入。</h5>
		         <div>
				     <a href="javascript:history.go(-1)">请点击这里返回上一页</a>
			     </div>		 
	        </div>
	         <p>&nbsp;&nbsp;</p>
	         <p>&nbsp;&nbsp;</p>

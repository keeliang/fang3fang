	...
	<body>
		...
		<div class="member_regContent">
			<div class="member_regContent_des">
				欢迎您注册房上房会员帐号，申请过程将不会收取您任何费用。您将享受更多房上房为您提供的功能、放心的会员服务。我们的服务热线是：<s:property value="@fsf.web.listener.SystemConfigInitListener@sysConfig.get('service_tel1')" />，<s:property value="@fsf.web.listener.SystemConfigInitListener@sysConfig.get('service_tel2')" />
			</div>

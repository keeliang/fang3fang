...
<s:if test="pageView!=null">
	<table align="right" class="pageNavigation" >
		<tr>
			...
			<td class="page">
				<s:select cssStyle="font-size:12px;" name="maxResultSelect" theme="simple" list="#{5:'5条',10:'10条',20:'20条',50:'50条' }" onchange="g_chageMaxResults(this.value)" value="baseParameter.maxResults" ></s:select>
			</td>
		</tr>
	</table>
</s:if>

						...
						<div class="freeTrade_contnetL_show03_con">
							...
							<div id="commentZoneDiv" style="display: none;" >
								<aa:zone name="commentZone">
									...
									<form name="commentForm" action="/entrustTrade/inEstCommentList.ajax" method="post" >
...
function f_queryComment(pageNum){
	document.forms["commentForm"].action = "/entrustTrade/inEstCommentList.ajax";
	if(pageNum){
...
function f_commitComment(){
	document.forms["commentForm"].action = "/entrustTrade/inCommitComment.ajax";
	ajaxAnywhere.getZonesToReload = function(){return "commentZone";} 
	ajaxAnywhere.showLoadingMessage = function(){

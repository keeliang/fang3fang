	...
	$("#TradingCommission div").click(function() {
		...
		switch(className) {
			case "1":
				...
				$("#TradingCommissionTable").append('<thead><TR><TH class="trade_tableW01">物业名称/地址</TH><TH class="trade_tableW02">城市</TH><TH class="trade_tableW02">区县</TH><TH class="trade_tableW03">商圈</TH><TH class="trade_tableW04">户型</TH><TH class="trade_tableW05">面积</TH><TH class="trade_tableW04">价格(万元/套)</TH><TH class="trade_tableW06">发布日期</TH></TR></thead>');
				...
				type: "POST",
				dataType: "xml",
				data: "useraction=Estates&referaction=SelectEstate&SellorRent=0&RequireSellRent=0&IsConsign=1&newHouse=0",
				success: function(xml) {
						...
						if  (maxitems>10){  
						  ...
						  for(var i = 0; i < 9; i++) {
							...
							$("#TradingCommissionTable tbody").append('<TR class="BODY"><td class="left"><a href="show.jsp?EstateMsgID='+EstateMsgID+'" title="'+PropertyName+'">'+PropertyName+'</a></TD><TD class="no2">'+CityName+'</TD><TD class="no3">'+DistrictName+'</TD><TD class="no4">'+TownName+'</TD><TD class="no5"><span class="cRed">'+Room+'</span>房<span class="cRed">'+Hall+'</span>厅 <span class="cRed">'+Toilet+'</span>卫</TD><TD class="no6">'+Area+'m<sup>2</sup></TD><TD class="no7">'+Cost+'万</TD><TD class="no8">'+FBDate+'</TD><TD>&nbsp;</TD></TR>');
						  }
						}else{
			...
			case "2":
				$("#TradingCommissionTable").empty();
				$("#TradingCommissionTable").append('<thead><TR><TH class="trade_tableW01">物业名称/地址</TH><TH class="trade_tableW02">城市</TH><TH class="trade_tableW02">区县</TH><TH class="trade_tableW03">商圈</TH><TH class="trade_tableW04">户型</TH><TH class="trade_tableW05">面积</TH><TH class="trade_tableW04">价格(元/月/套)</TH><TH class="trade_tableW06">发布日期</TH></TR></thead>');
				$("#TradingCommissionTable").append('<tbody></tbody>');
				$.ajax({
				url: "/Fang3FangWeb/Access",
				type: "POST",
				dataType: "xml",
				data: "useraction=Estates&referaction=SelectEstate&SellorRent=1&RequireSellRent=0&IsConsign=1&newHouse=0",
				success: function(xml) {
						var i;
						var properties = $(xml).find("Message");
						$(properties).children().each(function() {
			...
			case "3":
				$("#TradingCommissionTable").empty();
				$("#TradingCommissionTable").append('<thead><TR><TH class="trade_tableW02">城市</TH><TH class="trade_tableW02">区县</TH><TH class="trade_tableW03">商圈</TH><TH class="trade_tableW04">期望户型</TH><TH class="trade_tableW05">面积范围</TH><TH class="trade_tableW06">价格范围(万元/套)</TH><TH class="trade_tableW06">发布日期</TH></TR></thead>');
				$("#TradingCommissionTable").append('<tbody></tbody>');
				$.ajax({
				url: "/Fang3FangWeb/Access",
				type: "POST",
				dataType: "xml",
				data: "useraction=Estates&referaction=SelectEstate&SellorRent=0&RequireSellRent=1&IsConsign=1&newHouse=0",
				success: function(xml) {
						var i;
						var properties = $(xml).find("Message");
						$(properties).children().each(function() {
			...
			case "4":
				$("#TradingCommissionTable").empty();
				$("#TradingCommissionTable").append('<thead><TR><TH class="trade_tableW02">城市</TH><TH class="trade_tableW02">区县</TH><TH class="trade_tableW03">商圈</TH><TH class="trade_tableW04">期望户型</TH><TH class="trade_tableW05">面积范围</TH><TH class="trade_tableW06">价格范围(元/月/套)</TH><TH class="trade_tableW06">发布日期</TH></TR></thead>');
				$("#TradingCommissionTable").append('<tbody></tbody>');
				$.ajax({
				url: "/Fang3FangWeb/Access",
				type: "POST",
				dataType: "xml",
				data: "useraction=Estates&referaction=SelectEstate&SellorRent=1&RequireSellRent=1&IsConsign=1&newHouse=0",
				success: function(xml) {
						var i;
						var properties = $(xml).find("Message");
						$(properties).children().each(function() {
...
function pageselectCallback1(page_id, jq){
      ...
      var className = $("#TradingCommission div.active02").attr("id").substring(11);

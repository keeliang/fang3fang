			...
			<div class="memberC">
				...
				<div class="memberInfo" id="a1" style="display: block;">
					<div class="memberInfo_nav">
						<ul>
							<li class="memberInfo_navOn modify">
								<a href="#" onclick="javascript:jumpTo(1);"><b>个人基本信息</b>
								</a>
							</li>
							<li class="memberInfo_navOut password">
								<a href="#;" onclick="javascript:jumpTo(2);"><b>修改密码</b>
								</a>
							</li>
						</ul>
					</div>
					<div class="memberInfo_modify">
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							...
							<tr>
								<td colspan="2">
									...
									<textarea class="memberC_textarea02"></textarea>
								</td>
							</tr>
						</table>
						...
						<div class="blank10"></div>
						<div class="center">
							<a href="#"><img src="images/memberInfo_button.jpg"
									width="130" height="35" alt="完成编辑" title="完成编辑" />
							</a>
						</div>
						<div class="blank10"></div>
						<div class="blank10"></div>
						<p class="center cGray02">
							请完善您的个人详细资料，完善后将在发布信息时为您带来便捷的操作。
						</p>

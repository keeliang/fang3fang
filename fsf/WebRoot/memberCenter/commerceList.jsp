	...
	<body>
		<div class="memberC_box">
			...
			<div class="memberC">
				...
				<s:form action="commerceList" namespace="/memberCenter" name="formList" theme="simple" >
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" >
						...
						<tr>
							<td colspan="4" align="right" >
								<input type="button" onclick="g_new('/memberCenter/commerceNew.action')" value="<s:text name="g_new"/>"/>
								<input type="button" onclick="g_delete('/memberCenter/commerceDelete.action');" value="<s:text name="g_delete"/>">
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%" class="memberC_table" id="tblList" name="ListAJLoanTable">
						...
						<tbody>
							<s:iterator value="pageView.records" >
								<tr>
									<s:url action="commerceEdit" namespace="/memberCenter" id="url" includeParams="none" >
										<s:param name="commerceId" value="commerceId"></s:param>
									</s:url>
									<td>
										<input type="checkbox" name="selectedPK" value="<s:property value="commerceId"/>">
									</td>
									<td><a href="javascript:g_edit('${url}')" >${title }</a></td>

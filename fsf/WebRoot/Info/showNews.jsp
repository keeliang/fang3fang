	...
	<body>
		<div class="infoShow_box">
			...
			<div class="infoShow_head">
				...
				<p>
					<a href="../main/index.jsp"><u>首页</u></a> |
					<a href="../freetrade/index.jsp"><u>自主交易</u></a> |
					<a href="../entrustTrade/index.jsp"><u>委托代理</u></a> |
					<a href="../newHouse/index.jsp"><u>新房推荐</u></a> |
					<a href="../Info/index.jsp"><u>地产资讯</u></a> |
					<a href="../forum/index.jsp"><u>论坛</u></a> |
					<a href="../CoBank/index.jsp"><u>合作银行</u></a> |
					<a href="../rent/index.jsp"><u>旺铺招租</u></a> |
					<a href="../invitedexperts/index.jsp"><u>专家顾问</u></a>
				</p>
			</div>
			...
			<div class="infoShow_content">
				...
				<div class="infoShow_contentL">
					<div class="infoShow_contentL_img">
						<img src="images/AD-InfoShow2.jpg" width="550" height="150" alt="" title="" />
					</div>
					<div class="infoShow_contentL_guide">
						<p>
							...
							<a href="#">新闻</a> &gt;
							<a href="#">焦点</a> &gt;
							<span class="cOrange">${informationTitle }</span>
						</p>
					</div>
						...
						<div id="commentZoneDiv" style="display: none;" >
							<aa:zone name="commentZone">
								...
								<form name="commentForm" action="/Info/newsCommentList.ajax" method="post" >
									...
									<input name="newsCommentParameter.maxResults" type="hidden" value="10" />
									<input name="newsCommentParameter._ne_status" type="hidden" value="1" />
								</form>
							</aa:zone>
						</div>
					</div>
				...
				<div class="infoShow_contentR">
					...
					<div class="infoShow_contentR_title">
						<div class="infoShow_contentR_title_line"></div>
						<b>委托推荐</b>
					</div>
					<div class="col05a">
						<ul>
					...
					<div class="clear"></div>
					<div class="blank12"></div>
					<div class="infoShow_contentR_img02">
						<img src="images/infoS_img004.jpg" width="360" height="140" alt=""
							title="" />
					</div>
				</div>
...
function f_queryComment(pageNum){
	...
	if(pageNum){
		...
		document.forms["commentForm"]["newsCommentParameter.currentPage"].value = 1;
	}

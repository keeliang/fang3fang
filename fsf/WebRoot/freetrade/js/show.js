$(document).ready(function() {   
    ShowDetailCS();	 //显示资讯详细信息方法
	HloansCalculator();
	LeaveWord(); 
});

function ShowDetailCS(){
	...
	$.ajax({
		...
		type: "POST",
		dataType: "xml",
		data: "useraction=Estates&referaction=SelectEstateByID&SellorRent=0&RequireSellRent=0&IsConsign=0&EstateMsgID=" + id,
		cache: false,

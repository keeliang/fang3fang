...
<div class="box">
       ...
       <div class="navL">
					<div class="headMenu">
						...
						<ul class="menuList">
							...
							<li class="menuHere"><a href="<%=contextPath%>/commerce/commerceIndex.jsp"><span>旺铺招租</span></a></li> 
    ...
    <div class="wangpu_top">
    	<div class="wangpu_topL"><img src="images/wangpu_img01.jpg" width="709" height="101" alt="" title="" /></div>

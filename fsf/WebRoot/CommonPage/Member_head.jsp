...
<div class="member_head">
	<div class="member_logo">
		<a href="../main/index.jsp"><img src="images/logo.jpg" width="154"
				height="51" alt="房上房" title="房上房" />
		</a>
	</div>
	<p>
		<span><a href="../main/index.jsp"><u>首页</u></a></span> |
		<span><a href="../freetrade/index.jsp"><u>自主交易</u></a></span> |
		...
		<span><a href="<%=contextPath %>/forum/goToForum.action"><u>论坛</u></a></span> |
		<span><a href="<%=contextPath %>/CoBank/index.action"><u>合作银行</u></a></span> |

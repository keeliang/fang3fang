			...
			<!-- 
				...
				<div id="price">
					...
					<div id="divSaleIn_" style="display: none;" >
						...
						name="estateInParameter._nle_buyPriceFrom" onchange="f_query()" theme="simple" />
					</div>
				...
				<div id="area">
				[房型查询]:
				<a href="#" class="selected_filter">全部</a>
				<a href="#" class="choose_filter">一房</a>
				<a href="#" class="choose_filter">二房</a>
				<a href="#" class="choose_filter">三房</a>
				<a href="#" class="choose_filter">四房</a>
				<a href="#" class="choose_filter">五房</a>
				<a href="#" class="choose_filter">五房以上</a>
				</div>
		</div>
	</div>
</div>
    ...
    <div class="help_content">
    	<div class="help_contentL">
            ...
            <div class="blank12"></div>
                ...
                <li class="help_menuNav01_06 on"><a href="diya.jsp"><span class="float_right">&gt;&gt;</span>过户抵押</a></li>
            </ul>
            </div>
            <div class="blank12"></div>
        ...
        <div class="help_contentR">
        	<div class="help_contentR_title"><img src="images/help_diya.jpg" width="140" height="36" alt="过户抵押" title="过户抵押" /></div>
            <div class="help_contentR_line"></div>
            
    		<div class="blank12"></div>
            <p><b>1. 自主交易网为您提供非常便利的代办过户服务,全程仅需1000元,就有专业人员帮助您完成过户手续。</b></p>
	        <div class="blank12"></div>
            <p><b>2. <a href="#" class="cOrange"><u>常见过户、抵押问题</u></a></b></p>
            <div class="blank12"></div>

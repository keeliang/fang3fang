    ...
    <div class="help_content">
    	<div class="help_contentL">
            ...
            <div class="blank12"></div>
                ...
                <li class="help_menuNav01_03 on"><a href="bargain.jsp"><span class="float_right">&gt;&gt;</span>合同签署</a></li>
            ...
            <ul>
            <div class="blank12"></div>
            	<li class="help_menuNav02_01"><a href="issueHouse.jsp"><span class="float_right">&gt;&gt;</span>发布房源</a></li>
        ...
        <div class="help_contentR">
        	<div class="help_contentR_title"><img src="images/help_bargain.jpg" width="140" height="36" alt="合同签署" title="合同签署" /></div>
            <div class="help_contentR_line"></div>
            <p><b>1. 您已经看好卖家的房子，准备签合同购买了，那么有一些需要特别注意的事项，需写进合同的，一定要请您关注了。 </b></p>
    		<div class="blank12"></div>
            <p class="help_dot">注意签约主体是否合适。如卖方是否有房产证，产权是否清晰。同时交易前，作为买方，可要求卖方提供房屋的权属证明文件、身份证明及相关证件，并到所属房地产交易中心查验房屋的权属登记情况。房屋共有人没有签字，或者由其配偶代签。这样签合同，如果卖方反悔，则以夫妻一方不同意为由撕毁合同，容易发生不必要的纠纷</p>           
            <div class="blank12"></div>
            <p class="help_dot">明确付款过户操作方式。购买二手房付款方式由买卖双方协商决定，一般有一次性付款和按揭贷款两种方式。买卖双方的规避风险意识形成了“卖方不愿先过户，买方不愿先付款”的交易现状。在此推荐如下步骤的付款方式： 决定买房时，和卖方签订一个资金监管合同，并付一定数额的定金，需注意的是定金合同中要写明具体的房价； </p>           
            <div class="blank12"></div>
            <p class="help_dot">在签订《房屋买卖合同》时，付第一笔房款，所付定金同时转为房款；</p>  
            <div class="blank12"></div>
            <p class="help_dot">把过户手续交到交易中心当天，付第二笔房款；</p> 
            <div class="blank12"></div>
            <p class="help_dot">买方拿到产证的当天，付第三笔房款；</p> 
            <div class="blank12"></div>
            <p class="help_dot">办理房屋交接手续的当天，付清全部房款；如买方以按揭方式支付房款的，应付清除按揭款外的其他款项。</p>        
            <div class="blank12"></div>
            <p class="help_dot">明确生活费用的结算。水、电、煤、电话、物业管理费等结算手续一定要认真办理。 </p> 
            <div class="blank12"></div>
            <p class="help_dot">明确过户日期和房屋交接日期。过户日期和房屋交接日期是两码事，不能混淆。过户日期是房屋所有权转让的日期，而房屋交接日期直接决定了屋内的水电煤等费用是由卖方还是买方付。在签订房屋买卖合同时，应当注明房屋交接日期是在过户后第几个工作日或双方约定具体日期。房屋交接前的产生的费用由卖方承担，房屋交验后产生的费用由买方承担。 </p>
            <div class="blank12"></div>
            <p class="help_dot">明确户口迁出时间及违约责任。按照通常的交易习惯，卖方应当在过户或交房前将户口迁出。有时由于暂无能够入住户口的房屋或子女就学等原因，交易中卖方会要求推迟户口迁出的时间，这时，双方应书面约定户口迁出的时间及违约责任。鉴于户口一般无法强制迁出，买方对户口迁出延迟问题应当采取慎重的态度。</p>   
            <div class="blank12"></div>
            <p class="help_dot">明确交楼标准。包括装修，家私家电等。</p> 
            <div class="blank12"></div>
            <p class="help_dot">明确相关税费由谁支付。（房产交易税费计算与相关说明） </p>     
            <div class="blank12"></div>
            <div class="blank12"></div>
            <p><b>2. 房上房提供 <a href="doc/buy&amp;sell_bargain.doc" class="cOrange"><u>买卖合同样本</u></a> 下载,您可以根据实际情况在此基础上进行修改。</b></p>
            <div class="blank12"></div>
            <p><b>3. 房上房经纪人为您提供一站式服务，帮助您完成签约、过户直到交楼的全过程，全程您只需要1000元，一切就在您掌握中。</b></p>
            <div class="blank12"></div>
            <p><b>4. <a href="chargeService.jsp" class="cOrange"><u>收费服务</u></a></b></p>
            <div class="blank12"></div>
            <p><b>5. <a href="freeService.jsp" class="cOrange"><u>免费服务</u></a></b></p>

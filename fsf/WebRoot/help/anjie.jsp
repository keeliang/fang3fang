...
<div class="box">
    ...
    <div class="help_content">
        ...
        <div class="help_contentR">
        	<div class="help_contentR_title"><img src="images/help_anjie.jpg" width="140" height="36" alt="按揭贷款" title="按揭贷款" /></div>
            <div class="help_contentR_line"></div>
            <p class="cRed03 font12">自主交易网为买卖双方提供方便及时的银行在线按揭申请。您可以足不出户，就可以轻点鼠标，即刻完成银行二手房自主按揭申请。当然您如果看了以后觉得麻烦，您可以电话咨询、或者您已邀请了房上房经纪人的全程服务，您就无须再操心，交易中的所有问题经纪人会帮您解决。</p>
            <div class="blank12"></div>
    		<div class="blank12"></div>
            <p><b>1. 什么是按揭贷款 </b></p>
            <p class="help_dot">如果您要了解申请需要满足那些条件，请点击 <a href="#" class="cOrange"><u>这里</u></a></p>
            <p class="help_dot">房上房在线按揭申请流程</p>
            <div class="blank12"></div>
            <div class="help_contentR_title"><img src="images/help_liucheng02.jpg" width="205" height="570" /></div>
            <div class="blank12"></div>
            <p class="help_dot">如果您要查询银行对您的按揭申请的答复情况，请点击 <a href="#" class="cOrange"><u>银行查询答复</u></a></p>
            <p class="help_dot">点击此处，您可以进行 <a href="#" class="cOrange"><u>贷款计算</u></a></p>
	        <div class="blank12"></div>
            <p><b>2. 在线按揭申请通过以下几种途径都可以进入银行按揭受理申请系统: </b></p>
            <p class="help_dot">房上房自主交易网首页登录 <a href="#" class="cOrange"><u>会员中心</u></a></p>

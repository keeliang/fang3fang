    ...
    <div class="help_content">
    	<div class="help_contentL">
            ...
            <div class="blank12"></div>
                ...
                <li class="help_menuNav02_04 on"><a href="moneyManage02.jsp"><span class="float_right">&gt;&gt;</span>资金监管</a></li>
        ...
        <div class="help_contentR">
        	<div class="help_contentR_title"><img src="images/help_moneyManage02.jpg" width="140" height="36" alt="资金监管" title="资金监管" /></div>
            <div class="help_contentR_line"></div>
            <p class="cRed03 font12">银行为您提供免费的资金监管服务，请您尽量将信息填写全面，在收到申请的一个工作日内，我们会有专人负责与您联系。交易方式有两种：一、银行为第三方存管；二、即时交易即时付款，房上房有多年的专业经验，并且我们的理念让每一位顾客心安！做到顺利、安全交易是我们的宗旨。 </p>
            <div class="blank12"></div>
            <div class="help_contentR_title"><a href="#"><img src="images/help_button.jpg" width="195" height="49" alt="在线申请资金监管" title="在线申请资金监管" /></a></div>
    		<div class="blank12"></div>
            <p><b>1. 银行作为第三方监管 </b></p>
            <p class="indent24 font12">目前几大银行已推出第三方监管业务，房上房和多家银行有长期的合作关系，让您可以更方便地进行资金监管。</p>
            <div class="blank12"></div>
            <p><b>2. 二手房交易资金监管的方式</b></p>
            <p class="indent24 font12">资金监管银行采取帐户进行冻结，交易完成后解冻的方式。 </p>
            <div class="blank12"></div>
            <p><b>3. 即时交易即时付款</b><span class="cGray font12">（又分：为一次性付款和按揭付款）</span> </p>
            <p class="indent24 font12 cRed"><b>一次性付款</b></p>
            <p class="indent24 font12">在签定合同当天买家应支付楼款5%左右的订金。 </p>
            <p class="indent24 font12">去房管局当天业主应确认买方有无准备足够的楼款，如有可以在完成过户手续拿到回执后付款。业主也无须担心，因在法律上原业主有5天的财产保全权利。</p>
            <p class="indent24 font12">在实际的交易经验中风险极低，并且方便、快捷，所以这种方式顾客都会选择。 </p>
            <div class="blank12"></div>
            <p class="indent24 font12 cRed"><b>按揭付款</b></p>
            <p class="indent24 font12">在签定合同当天买家应支付楼款5%左右的订金。 </p>
            <p class="indent24 font12">去房管局当天业主应确认买方有无准备足够的楼款，如有可以在完成过户手续拿到回执后付款。业主也无须担心，因在法律上原业主有5天的财产保全权利。 </p>
            <p class="indent24 font12">在实际的交易经验中风险极低，并且方便、快捷，所以这种方式顾客都会选择。</p>
            <div class="blank12"></div>
            <p><b>4. 申请二手房交易资金监管时需要提供的资料</b></p>
            <p class="help_dot">交易双方具有法律效力的身份证件原件及复印件 </p>
            <p class="help_dot">待过户的房地产权利证书原件及复印件</p>
            <p class="help_dot">真实有效的二手房买卖合同原件及复印件</p>
            <p class="help_dot">双方签字的《二手房交易资金监管协议》</p>
            <div class="blank12"></div>
            <p><b>5. 二手房交易资金监管业务流程 </b></p>
            <div class="blank12"></div>
            <div class="help_contentR_title"><img src="images/help_liucheng.jpg" width="205" height="303" /></div>

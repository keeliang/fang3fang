...
--
-- Table structure for table 'forum_role_values'
--
DROP TABLE IF EXISTS forum_role_values;
CREATE TABLE forum_role_values (
...
--
DROP TABLE IF EXISTS forum_karma;
...
-- 
-- Table structure for table 'forum_quota_limit'
--
DROP TABLE IF EXISTS forum_quota_limit;
CREATE TABLE forum_quota_limit (
...
--
-- Table structure for table 'forum_attach'
--
DROP TABLE IF EXISTS forum_attach;
CREATE TABLE forum_attach (
...
-- 
-- Table structure for table 'forum_attach_desc'
--
DROP TABLE IF EXISTS forum_attach_desc;
CREATE TABLE forum_attach_desc (
...
--
-- Table structure for table 'forum_attach_quota'
--
DROP TABLE IF EXISTS forum_attach_quota;
CREATE TABLE forum_attach_quota (
...
--
-- Table structure for table 'forum_banner'
--
...
--
-- Table structure for table 'forum_mail_integration'
--
DROP TABLE IF EXISTS forum_mail_integration;
CREATE TABLE forum_mail_integration (
	forum_id INT NOT NULL,
...
--
-- Table structure for table 'forum_api'
--
DROP TABLE IF EXISTS forum_api;
CREATE TABLE forum_api (
...
alter table forum_users drop sys_user_code,
	add sys_user_code int not null default 0 comment '系统用户表编码' after user_id;